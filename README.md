...
3 - Extra) If you have additional time, try the following:
a) Generate a categorical variable W4 (eg. three different age groups, colors, or countries)
b) Summarize your data separately by each category of W4
c) Visualize your data separately by each category of W4 (hint: look up `facet_wrap` in ggplot2)
3 - Extra Extra)  Compute the correlation between W1 and W2, W1 and Y, and W2 and Y. How is are these quantities related to the way that W1, W2, and Y were generated?
